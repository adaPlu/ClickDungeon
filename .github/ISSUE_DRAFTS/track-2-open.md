...
Summary
-------
This issue provisions and validates the connected services required for Track 2: Firebase (`google-services.json`, App Check) and Play Console access for purchase validation. It covers required artifacts, owners, tasks, and acceptance criteria.

Owners & Contacts
------------------
- Owner: @<OWNER_GH_HANDLE>
...
Security Notes
--------------
Never commit `google-services.json`, Play service account keys, or private signing keys to git. Store them in the organization's secrets manager and document retrieval steps here.
