...
public class GameActivityGridAnimationThrottleTest {
    ...
    public void detachClearsAnimationEntry() {
        ...
        grid[0][0] = new Tile(TileType.ENEMY, new com.adaplu.clickdungeon.model.Monster("Slime", 3, 1, 0, "S"));
    ...
    public void registryTracksOnlyActiveAnimatedTiles() {
        ...
        Tile hiddenEnemy = new Tile(TileType.ENEMY, new com.adaplu.clickdungeon.model.Monster("Slime", 3, 1, 0, "S"));
        Tile revealedEnemy = new Tile(TileType.ENEMY, new com.adaplu.clickdungeon.model.Monster("Goblin", 4, 2, 1, "G"));
