...
public final class SecurePreferences {
    ...
    public static SharedPreferences get(Context context, String name) {
        ...
        try {
            ...
            Log.w(TAG, "Failed to initialize encrypted prefs", ex);
    ...
    private static String encryptValue(Aead aead, String key, String payload) {
        try {
            ...
            Log.w(TAG, "Failed to encrypt preference value", ex);
            return null;
        }
    }
    ...
    private static String decryptValue(Aead aead, String key, String stored) {
        ...
        try {
            ...
            Log.w(TAG, "Failed to decrypt preference value", ex);
            return null;
        }
    }
    ...
    private static final class TinkEditor implements SharedPreferences.Editor {
        ...
        public SharedPreferences.Editor putString(String key, String value) {
            ...
            if (encrypted != null) {
                ...
                Log.w(TAG, "Failed to encrypt string preference; write skipped");
            }
            return this;
        }
        ...
        public SharedPreferences.Editor putInt(String key, int value) {
            ...
            if (encrypted != null) {
                ...
                Log.w(TAG, "Failed to encrypt int preference; write skipped");
            }
            return this;
        }
        ...
        public SharedPreferences.Editor putBoolean(String key, boolean value) {
            ...
            if (encrypted != null) {
                ...
                Log.w(TAG, "Failed to encrypt boolean preference; write skipped");
            }
            return this;
        }
        ...
        public SharedPreferences.Editor putLong(String key, long value) {
            ...
            if (encrypted != null) {
                ...
                Log.w(TAG, "Failed to encrypt long preference; write skipped");
            }
            return this;
        }
        ...
        public SharedPreferences.Editor putFloat(String key, float value) {
            ...
            if (encrypted != null) {
                ...
                Log.w(TAG, "Failed to encrypt float preference; write skipped");
            }
            return this;
        }
